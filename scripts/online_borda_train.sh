...
python -u train_qlora.py model=phi2 datasets=[jokes] loss=dpo loss.beta=0.1 exp_name=test gradient_accumulation_steps=6 batch_size=32 eval_batch_size=8  sample_during_eval=True active=True pretrain=False have_llm_dropout=True debug=True
#
